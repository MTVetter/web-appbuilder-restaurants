...
define(['dojo/_base/declare',
  ...
  function(declare, lang, html, on, query, cookie, _WidgetsInTemplateMixin, BaseWidget,
           CheckBox, utils, esriLang, LoadingShelter, PanelManager, array, WidgetManager, Deferred) {
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      onOkClick: function() {
        ...
        //===================================================================================
        //Add these lines of codes to open the introJS after clicking OK on the splash screen
        var widgetsConfig = this.appConfig.widgetPool.widgets;
        var widgetId;
        for (var i in widgetsConfig){
          if (widgetsConfig[i].name == "introJS"){
